...
```{r}
critics <- read.csv('/Users/taniaelachkar/Desktop/MBD/Term 2/Recommendation Engines/Lab1/Lab1_Tania_ElAchkar/critics.csv', sep=',', dec=',')
...
```{r}
movies <- read.csv("/Users/taniaelachkar/Desktop/MBD/Term 2/Recommendation Engines/Lab1/Lab1_Tania_ElAchkar/movies.csv", sep=',')
ratings <- read.csv("/Users/taniaelachkar/Desktop/MBD/Term 2/Recommendation Engines/Lab1/Lab1_Tania_ElAchkar/ratings.csv", sep=',')
head(movies)
head(ratings)
```
